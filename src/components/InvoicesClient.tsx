      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex gap-2 flex-shrink-0">
          ...
          <Link
            ...
            className="flex items-center gap-2 border border-gray-200 text-gray-600 font-medium px-3.5 py-2 rounded-xl text-sm hover:bg-gray-50 transition-colors active:scale-95"
          >
